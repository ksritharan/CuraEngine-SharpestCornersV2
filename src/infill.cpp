...
void Infill::generate(VariableWidthPaths& toolpaths, Polygons& result_lines, const Settings& settings, const SierpinskiFillProvider* cross_fill_provider, const SliceMeshStorage* mesh)
{
    // generate walls
